...
export const getAllPizzas = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`${url}/api/pizzas/getAllPizzas`);
...
export const addPizza = (pizza) => async (dispatch) => {
  ...
  try {
    await axios.post(`${url}/api/pizzas/addpizza`, { pizza });
...
export const getPizzaById = (pizzaId) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${url}/api/pizzas/getpizzabyid`, { pizzaId });
...
export const updatePizza = (updatedPizza) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${url}/api/pizzas/updatepizza`, {
      updatedPizza,
    });
